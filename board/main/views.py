...
from main.forms import ProfileEditForm, RegisterForm, SearchForm, BbForm, AIFormSet, GuestCommentForm, UserCommentForm
...
class BBLogoutViews(LogoutView):
    pass
...
def profile_bb_detail(request, rubric_pk, pk):
    ...
    if request.user.is_authenticated:
        ...
        return HttpResponse('Выполните вход!')
